...
import RandomBoxScreen from "./src/screens/RandomBoxScreen";
  ...
  return (
    <NavigationContainer styles={styles.container}>
      <Stack.Navigator>
        ...
        <Stack.Screen name='RandomBox' component={RandomBoxScreen} />
        <Stack.Screen name='Desing' component={DesingScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
